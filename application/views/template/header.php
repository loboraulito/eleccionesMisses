    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Eleccion Miss Oruro   </a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">loboraulito@hotmail.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url('index.php/admin/jurado');?>">
                            <i class="material-icons">account_circle</i>
                            <span>Jurados</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('index.php/admin/participante');?>">
                            <i class="material-icons">assignment</i>
                            <span>Participantes</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('index.php/admin/pasarela');?>">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 <a href="javascript:void(0);">Sistema Elecciones</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.1
                </div>
