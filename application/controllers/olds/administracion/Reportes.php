...
class Reportes extends CI_Controller
{
    ...
    function index(){
        ...
        {            
            $data['contenido_principal'] = 'administracion/reportes';
...
EOD;
	...
	<tr>
		...
		<th align="center" width="280">Descripcion</th>
        <th align="center" width="120">Codigo POA</th>
        <th align="center" width="80">Tipo de Proyecto</th>
		<th align="center" width="100">Unidad Funcional</th>
        <th align="center" width="165">Responsable Proyecto</th>
...
EOD;
    ...
    function reporte_proyectos_fuente()
    {
    	$proyectos = $this->proyecto_model->get_todos_reporte();
    	...
    	foreach ($proyectos as $proyecto){
    		$texto=$texto.'<hr><br><table cellspacing="0" cellpadding="1" border="1" style="background-color:yellow;">
			<tr>
		        <th align="center" width="30"><strong>Nro.</strong></th>
		        <th align="center" width="90">Codigo SISIN</th>
				<th align="center" width="400">Descripcion</th>
		    	<th align="center" width="70">Monto</th>
			</tr>';
    		...
    		$fuentes = $this->proyecto_fuente_model->get_todos_limite_where($proyecto->codigo_sisin);
    		
    		$texto=$texto.'<table cellspacing="0" cellpadding="1" border="1">
			<tr>
		        <th align="center" width="90"><strong>Código fuente</strong></th>
		        <th align="center" width="90">Sigla Fuente</th>
    		...
    		foreach ($fuentes as $fuente){
	    		$texto=$texto.'<tr>
			        <td>'.$fuente->id_fuente_organismo.'</td>
		            <td>'.$fuente->sigla.'</td>
		            <td>'.$fuente->descripcion_organismo.'</td>
		            <td>'.$fuente->monto.'</td>
		            <?php ?>
